...
export default function Header(props) {
    ...
    const menuOptions = [
        ...
        { name: "Mobile App Development", link: "/mobileapps", activeIndex: 1, selectedIndex: 2 }, //activeIndex: index of the active tab in the AppBar. selectedIndex: Inside the services menu at index 2 is choice Mobile App Development
